...
# print(flat_bed_volume*biomass_density)
# print(flat_bed_volume*bio_oil_density)
...
class TEA:
    ...
    def NPV(self):
        logistic_costs = (
            ...
            * self.system.flowsheet.stream["Blend_oil"].get_total_flow("tonnes/year") 
    ...
    def mfsp_table(self, product=None, solve=True):
        ...
        costs["Bio Oil Credit"] = (
            -self.bio_oil_plug_value
            * self.system.flowsheet.stream["Blend_oil"].get_total_flow("kg/hr")
            * self.operating_days
            * 24
        )
